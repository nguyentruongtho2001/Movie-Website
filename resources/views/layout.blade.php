                        ...
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            @foreach ($category as $key => $cate)
                                <li class="mega"><a title="{{ $cate->title }}"
                                        href="{{ route('categorypage', $cate->slug) }}">{{ $cate->title }}</a>
                                </li>
                            @endforeach
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    @foreach ($genre as $key => $gen)
                                        <li><a title="{{ $gen->title }}"
                                                href="{{ route('genrepage', $gen->slug) }}">{{ $gen->title }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </li>
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    @foreach ($country as $key => $countr)
                                        <li><a title="{{ $countr->title }}"
                                                href="{{ route('countrypage', $countr->slug) }}">{{ $countr->title }}</a>
                                        </li>
                                    @endforeach
