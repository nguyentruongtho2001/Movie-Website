     ...
     <div class="row container" id="wrapper">
         <div class="halim-panel-filter">
             <div class="panel-heading">
                 <div class="row">
                     <div class="col-xs-6">
                         <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">{{ $countr_slug->title }}</a> »
                                     <span class="breadcrumb_last" aria-current="page">2024</span></span></span>
                         </div>
                     </div>
                 </div>
             </div>
         ...
         <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
             <section>
                 <div class="section-bar clearfix">
                     <h1 class="section-title"><span>{{ $countr_slug->title }}</span></h1>
                 </div>
                 <div class="halim_box">
                     ...
                     <div role="tabpanel" class="tab-pane active halim-ajax-popular-post">
                         ...
                         <div id="halim-ajax-popular-post" class="popular-post">
                             <div class="item post-37176">
                                 <a href="{{ route('moviepage', $mov->slug) }}" title="CHỊ MƯỜI BA: BA NGÀY SINH TỬ">
                                     <div class="item-link">
